...
import CategoHalf from './CategoHalf'
    ...
    return (
      <FlipMove className="justify-center  flex flex-wrap mx-2">
        {limitedEvents.map((event) => (
          <li key={event.id}
            className="text-white w-4/5 md:w-2/5 items-center justify-center lg:w-1/5 mx-6 rounded-xl my-2"
          >
            ...
            <img
              className="w-full h-36 bg-gray-900 rounded-xl "
              src={event.image}
            />
      ...
      <div className="justify-center bg-gray-900 ">
        ...
        <div className="relative">
          <img
            ...
            src="https://ghnvkxjbfxberpmnzjuk.supabase.co/storage/v1/object/public/images/city/city.jpg"
            alt="City Image"
            ...
            <div className="flex flex-wrap justify-between mx-2 ">
              ...
              {categories.map((category, index) => (
                ...
                >
                  ...
                  <button
                    key={category}
                    className={`text-gray-200 flex justify-between text-center shadow-sm w-4/5 shadow-black pl-2 transition-all duration-500 hover:scale-110 hover:opacity-100 border-white my-1 pt-1 ml-2 md:text-sm xl:text-xl items-center rounded-full ${selectedCategory === category ? 'shadow-md shadow-white opacity-100' : ' opacity-95'
                      }`}
                      ...
                      >
                        <Popup >
                          ...
                          >
                            ...
                            <img
                              className="w-full h-36 bg-gray-800 rounded-xl "
                              src={event.image}
                            />
